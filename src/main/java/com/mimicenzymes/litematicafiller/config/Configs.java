...
public class Configs {
    ...
    public static final ConfigBoolean ENABLE_REMOTE_FETCH = new ConfigBoolean("litematica_container_filler.config.name.enableRemoteFetch", true, "litematica_container_filler.config.comment.enableRemoteFetch");
    public static final ConfigBoolean AUTO_FETCH_FROM_PRINTER_MEMORY = new ConfigBoolean("litematica_container_filler.config.name.autoFetchFromPrinterMemory", true, "litematica_container_filler.config.comment.autoFetchFromPrinterMemory");
